...
/**
 * 使用ScheduledThreadPoolExecutor模拟温室控制器
 */
public class ScheduledThreadPoolExecutorTest {
	/*
	ScheduledThreadPoolExecutor
	1. 可另外调度在给定延迟之后运行的命令，或定期执行。
	 */
	...
	class CollectData implements Runnable {
		public void run() {
			...
			synchronized (ScheduledThreadPoolExecutorTest.this) {
	...
	public static void main(String[] args) {
		ScheduledThreadPoolExecutorTest gh = new ScheduledThreadPoolExecutorTest();
