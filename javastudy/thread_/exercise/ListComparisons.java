package javastudy.thread_.exercise;//: concurrency/ListComparisons.java
...
class SynchronizedArrayListTest extends ListTest {
	List<Integer> containerInitializer() {
		return Collections.synchronizedList(RandomGenerator.Collection.getRandomIntegerList(containerSize));
	}
...
class CopyOnWriteArrayListTest extends ListTest {
	List<Integer> containerInitializer() {
		return new CopyOnWriteArrayList<>(RandomGenerator.Collection.getRandomIntegerList(containerSize));
	}
...
/**
 * 使用框架测试synchronizedList和CopyOnWriteArrayList的读写
 */
