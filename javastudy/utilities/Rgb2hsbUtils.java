 ...
 * RGB转HSB工具
 */
public class Rgb2hsbUtils {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        int rgbR = scanner.nextInt();
        int rgbG = scanner.nextInt();
        int rgbB = scanner.nextInt();
        float[] floats = rgb2hsb(rgbR, rgbG, rgbB);
        System.out.println(floats[0]+"f,"+floats[1]+"f,"+floats[2]+"f");
    }
